...
export function WeekView({ currentDate, events, onEventClick, onDateClick, onEventDrop }: WeekViewProps) {
  const days = useMemo(() => {
        ...
        {days.map((day) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="text-xs text-muted-foreground mb-1">{format(day, "E", { locale: ja })}</div>
                <div className={cn(
                      ...
                      >
                        <div className="flex items-center gap-2 mb-1.5">
                          ...
                          {event.status === "published" && (
                            <Badge variant="secondary" className="ml-auto text-[10px] px-1 py-0 h-4 bg-white/20">済</Badge>
                          )}
                        </div>
