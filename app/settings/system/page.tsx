...
export default function SystemSettingsPage() {
  ...
  const updateSnsSettings = (
    platform: keyof SystemSettings["sns"],
    field: string,
            ...
            <TabsContent value="api" className="space-y-6 outline-none">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            {settings.sns.x.connected ? (
                              <Badge
                                variant="default"
                                className="bg-green-500 hover:bg-green-600 text-[10px] h-5"
                              >
                                連携済み
                              </Badge>
                            ) : (
                  ...
                  <div className="space-y-4 rounded-lg border bg-muted/20 p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateSnsSettings("instagram", "accessToken", e.target.value)
                        }
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateSnsSettings("line", "channelToken", e.target.value)
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateSnsSettings("line", "channelSecret", e.target.value)
                          }
              ...
              <Card className="rounded-lg border-border/70 shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Google
                    Analyticsなどのアクセス解析ツールと連携し、ダッシュボードにデータを表示します。
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid gap-2">
                  ...
                  <div className="space-y-3">
                    ...
                    {settings.workflow.autoCleanupDays !== "never" && (
                      <div className="flex items-center gap-2 rounded-md bg-amber-50 p-3 text-sm text-amber-700 dark:bg-amber-950/50 dark:text-amber-400">
                        ...
                        <span>
                          注意:
                          削除されたデータは復元できません。お気に入りに登録されたアイテムは削除対象外です。
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-4 rounded-lg border bg-muted/20 p-4">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateNotificationSettings("emailWeeklyReport", checked)
                        }
                      />
                    </div>
                  ...
                  <div className="pt-4 border-t space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-4 rounded-lg border bg-muted/20 p-4">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          updateNotificationSettings("inAppToast", checked)
                        }
                      />
                    </div>
                  </div>
